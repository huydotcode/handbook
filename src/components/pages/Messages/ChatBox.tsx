...
const ChatBox: React.FC<Props> = ({ isPopup, className }) => {
    ...
    return (
        ...
        >
            ...
            <div
                className={cn(
                    'w-full dark:border-y-gray-600 py-2 overflow-y-auto overflow-x-hidden',
                    {
                        ...
                        'md:fixed md:bottom-14 h-[calc(100%-56px-64px)]':
                            !isPopup,
                    }
                )}
            >
            ...
            <form
                className={cn(
                    'fixed zbottom-0 left-0 right-0 w-full flex items-center justify-center p-2 z-50 bg-white dark:bg-dark-200 border-t dark:border-gray-700 h-14',
                    {
